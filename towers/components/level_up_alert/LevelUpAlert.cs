...
{
    [Export] public float time_to_vanish = 3f;
    ...
    public override async void _Ready()
    {
        ...
        tween1.TweenProperty(_levelUp, "position", new Vector2(randomNumber, -30), time_to_vanish / 2f);

        var tween2 = CreateTween();
        tween2.TweenProperty(_levelUp, "modulate:a", 0.0f, time_to_vanish / 2f);
