...
func connect_pieces(piece_a: MapPiece, piece_b: MapPiece, dir_a: Edge.Dir, dir_b: Edge.Dir) -> void:
...
func find_connection_dir(from_piece: MapPiece, to_piece: MapPiece) -> Edge.Dir:
